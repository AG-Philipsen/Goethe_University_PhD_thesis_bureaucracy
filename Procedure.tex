...
\begin{document}
    ...
    \section*{Printing the thesis}
        ...
        \begin{itemize}
            \item You can use the \website[http://druck.uni-frankfurt.de/druckzentrum/]{university print service}.
                  Some of the previous students have been very pleased with the result. In general it takes a couple of days,
                  and costs approximatively between \euro$\,15$ and \euro$\,20$ per copy.
    ...
    \section*{Summary of needed documents for the submission}
        ...
        \begin{itemize}
            ...
            \item A \file[Erlaerung_Formular.pdf]{signed declaration} that you have carried out the work independently;
    ...
    \section*{Organising a defence}
        ...
        At this stage, you should fix a committee as well as a date for your defence.
