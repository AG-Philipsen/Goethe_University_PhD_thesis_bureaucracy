...
\begin{document}
    ...
    \section*{Printing the thesis}\label{printing}
        ...
        \begin{itemize}
            ...
            \item Upon handing in, you will receive an info sheet which tells you to hand in your printing bill to Dekanat, as they sponsor your dissertation printing with up to \euro$\,150$.
        \end{itemize}
    ...
    \section*{Summary of needed documents for the submission}\label{submission}
        ...
        \begin{itemize}
            ...
            \item A \file[Erklaerung-ueber-Daten.pdf]{signed declaration} to express consent for the treatment of personal data;
            ...
            \item Update 2025: The defense committee form, as described in the next section, is already expected to be filled and brought with you for handing in. I didn't know this and could still                   hand in, however. \emph{Niklas}-
        \end{itemize}
        So basically you just \file[Promotionsbuero\_Anfahrtsplan.pdf]{walk over} to the Promotionsb\"uro and hand it all in.
        They will give you a bill of \euro$\,150$ which you have to pay, and that is basically it.
    ...
    \section*{Organising a defence}\label{defence}
        ...
        As one can see from the form, you need to appoint a chairman, and someone who writes the PhD protocol.
